...
public class ShellUtils {
     ...
     * </ul>
     */
    public static CommandResult execCommand(String[] commands, boolean isRoot, boolean isNeedResultMsg) throws RuntimeException {
        int result = -1;
...
//            Log.d("shellutil", "waiting for result end , isNeedResultMsg " + isNeedResultMsg + ", result = " + result );
            // get command result
            if (isNeedResultMsg) {
